...
class ProfilController extends AbstractController
{
    ...
    public function edit(Request $request, UilisateurRepository $repo, SluggerInterface $slugger,
                         #[Autowire('%kernel.project_dir%/public/uploads/avatars')] string $brochuresDirectory): Response
    {
